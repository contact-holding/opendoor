...
export default function ModalContactProprietaire({
  ouvert,
  onFermer,
  titreLogement,
}: {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-encre/50 px-4">
      <div className="relative w-full max-w-sm rounded-2xl bg-fond p-6 shadow-xl">
        ...
        <h3 className="font-display text-lg">Contacter le propriétaire</h3>
        <p className="mt-1 text-sm text-encre/60">À propos de : {titreLogement}</p>
