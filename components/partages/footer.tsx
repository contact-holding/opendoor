...
function IconeTwitter() {
  return (
    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
      <path d="M18.9 2H22l-7.6 8.7L23 22h-7l-5.5-6.7L4 22H1l8.1-9.3L1 2h7.2l5 6.1L18.9 2Zm-1.2 18h1.7L7.4 4H5.5L17.7 20Z" />
    </svg>
  );
}
      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-fond/60">
            ...
            <li><Link href={base + "/recherche?ville=Edéa"}>Edéa</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-fond/60">
            <li><Link href={base + "/a-propos"}>À propos</Link></li>
            <li><Link href={base + "/contact"}>Contact</Link></li>
            <li><Link href={base + "/politique-confidentialite"}>Confidentialité</Link></li>
            <li><Link href={base + "/conditions-generales"}>Conditions générales</Link></li>
          </ul>
        </div>
      </div>
